...
var base_cl		= L.tileLayer('http://{s}.tiles.mapbox.com/v3/ignacioabe.j74kak2h/{z}/{x}/{y}.png'),
    ...
    puntos		= L.tileLayer('http://{s}.tiles.mapbox.com/v3/ignacioabe.jk3p7gb9/{z}/{x}/{y}.png');
...
//meter todo el html dentro de div>contenidos
    ...
    <div id="contenidos">
        ...
        <style>
          body { margin:0; padding:0; }
          #map { position:absolute; top:0; bottom:0; width:100%; margin-top:65px; z-index:-1;}
		...
		<script>
        var map = L.mapbox.map('map', 'ignacioabe.map-u0vknw7q')
            .setView([-33.43815635343959, -70.6381630897522], 14);
